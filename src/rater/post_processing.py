...
class SpanGetter:
    def __init__(
        ...
        max_span_len=None,
        min_target_score=0,
        start_checking_window=3,
        end_checking_window=1,
    ):
        assert step > 0
    ...
    def could_be_end(self, i):
        ...
        score = self.seg_target[
            max(0, i - self.end_checking_window + 1, i) : i + 1
        ].mean(0)
...
def get_preds_seg_v2(
    ...
    span_getter=None,
    target_getter=None,
    span_getter_kwargs=None,
    target_getter_kwargs=None,
):
